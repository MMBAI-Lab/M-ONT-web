...
export type DaySchedule = {
  day: string;
  date: string;
  /** One-word nature of the day, shown in the at-a-glance strip at the top of the page. */
  kind: string;
  slots: ScheduleEntry[];
};
...
const en: DaySchedule[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { time: "13:30–14:20", speaker: "Pablo D. Dans", title: "In-silico folding of aptamers and computer-aided design of siRNAs", type: "talk" },
...
const es: DaySchedule[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { time: "13:30–14:20", speaker: "Pablo D. Dans", title: "Plegamiento in silico de aptámeros y diseño de siRNAs asistido por computadora", type: "talk" },
