...
const en: DaySchedule[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { time: "14:00 onwards", speaker: null, title: "Winery visit — farewell lunch", type: "session" },
    ],
  },
];
...
const es: DaySchedule[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { time: "14:00 en adelante", speaker: null, title: "Visita a bodega — almuerzo de despedida", type: "session" },
    ],
  },
];
